...
public class PasswordForgotRequest {
    ...
    public PasswordForgotRequest(String username) {
        this.username = username;
    }

    public @NotBlank @Email(regexp = emailRegex) String getUsername() {
        return username;
    }

    public void setUsername(@NotBlank @Email(regexp = emailRegex) String username) {
        this.username = username;
    }
    ...
    public boolean equals(Object o) {
        ...
        PasswordForgotRequest that = (PasswordForgotRequest) o;
